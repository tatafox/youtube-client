import { IResponse } from '../models/search-response.models';

const youtubeResponse: IResponse = {
  ...
  items: [
    ...
    },
    {
      ...
      id: 'VAkio68d51A',
      snippet: {
        publishedAt: '2022-03-25T00:09:23.000Z',
    ...
    },
    {
      ...
      id: 'G0bBLvWXBvc',
      snippet: {
        publishedAt: '2022-03-29T16:53:41.000Z',
